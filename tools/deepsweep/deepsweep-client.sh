...
g++ -std=c++17 -O3 -ffast-math -I include -I external/highfive/include $OPTS -lhdf5 -DRL_TOOLS_ENABLE_JSON -DRL_TOOLS_ENABLE_HDF5 -DDMODEL=$DMODEL src/foundation_policy/post_training/main.cpp -o $EXPERIMENT/a.out $OPTS
