...
EXPERIMENT=deepsweep_runs/$DEEPSWEEP_JOB/SEED-${SEED}_DMODEL-${RL_TOOLS_DMODEL}_NUM_EPISODES-${RL_TOOLS_NUM_EPISODES}_NUM_TEACHERS-${RL_TOOLS_NUM_TEACHERS}
mkdir -p $EXPERIMENT
