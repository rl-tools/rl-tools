...
struct parameters_pendulum_0{
    ...
    struct rl{
        ...
        using OPTIMIZER_PARAMETERS = typename rlt::nn::optimizers::adam::Specification<T, TI>;
        ...
        using OFF_POLICY_RUNNER_SPEC = rlt::rl::components::off_policy_runner::Specification<T, TI, ENVIRONMENT, N_ENVIRONMENTS, false, REPLAY_BUFFER_CAP, ENVIRONMENT_STEP_LIMIT, rlt::rl::components::off_policy_runner::DefaultParameters<T> >;
