...
//                        backprop_tools::rl::environments::multirotor::parameters::init::simple<T, TI, 4, REWARD_FUNCTION>,
        ...
        using ENVIRONMENT_SPEC = bpt::rl::environments::multirotor::Specification<T, typename DEVICE::index_t, PARAMETERS, bpt::rl::environments::multirotor::StaticParametersDefault<TI>>;
    ...
    struct rl{
        ...
        using OFF_POLICY_RUNNER_SPEC = bpt::rl::components::off_policy_runner::Specification<T, TI, ENVIRONMENT, N_ENVIRONMENTS, false, REPLAY_BUFFER_CAP, ENVIRONMENT_STEP_LIMIT, OFF_POLICY_RUNNER_PARAMETERS>;
