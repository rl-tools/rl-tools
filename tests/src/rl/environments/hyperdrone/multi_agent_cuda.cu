...
namespace test_multi_agent_cuda {
...
using namespace test_multi_agent_cuda;
...
TEST(RL_TOOLS_RL_ENVIRONMENTS_HYPERDRONE_MULTI_AGENT_CUDA, AGENTS_STEP_SEE_AND_COLLIDE){
    if(SCENE_PATH.empty()){
    ...
    rlt::malloc(device_gpu, gpu.parameters);
    rlt::malloc(device_gpu, gpu.states);
    rlt::malloc(device_gpu, gpu.next_states);
    rlt::malloc(device_gpu, gpu.reset_mask);
    rlt::malloc(device_gpu, gpu.actions);
    rlt::malloc(device_gpu, gpu.observations);
    rlt::malloc(device_gpu, gpu.observations_privileged);
    rlt::malloc(device_gpu, gpu.rewards);
    rlt::malloc(device_gpu, gpu.terminated_flags);
    rlt::set_all(device_gpu, gpu.reset_mask, true);
    rlt::set_all(device_gpu, gpu.actions, (T)0);
    rlt::sample_initial_parameters(device_gpu, world, gpu.parameters, gpu.reset_mask, rng);
    rlt::sample_initial_state(device_gpu, world, gpu.parameters, gpu.states, gpu.reset_mask, rng);
    cudaDeviceSynchronize();
    rlt::copy(device_gpu, device, gpu.parameters, tensors.parameters);
    rlt::copy(device_gpu, device, gpu.states, tensors.states);
    arrange(device, tensors);
    rlt::copy(device, device_gpu, tensors.parameters, gpu.parameters);
    rlt::copy(device, device_gpu, tensors.states, gpu.states);
    ...
    rlt::observe(device_gpu, world, gpu.parameters, gpu.states, typename WORLD::Observation{}, gpu.observations, rng);
    cudaDeviceSynchronize();
    ...
    rlt::copy(device, device_gpu, tensors.states, gpu.states);
    rlt::step(device_gpu, world, gpu.parameters, gpu.states, gpu.actions, gpu.next_states, rng);
    rlt::reward(device_gpu, world, gpu.parameters, gpu.states, gpu.actions, gpu.next_states, gpu.rewards, rng);
    cudaDeviceSynchronize();
    rlt::copy(device_gpu, device, gpu.next_states, tensors.next_states);
    {
    ...
    rlt::observe(device_gpu, world, gpu.parameters, gpu.states, typename WORLD::ObservationPrivileged{}, gpu.observations_privileged, rng);
    cudaDeviceSynchronize();
    rlt::copy(device_gpu, device, gpu.observations_privileged, tensors.observations_privileged);
    {
    ...
    rlt::copy(device, device_gpu, tensors.states, gpu.states);
    rlt::terminated(device_gpu, world, gpu.parameters, gpu.states, gpu.terminated_flags, rng);
    cudaDeviceSynchronize();
    rlt::copy(device_gpu, device, gpu.terminated_flags, tensors.terminated_flags);
    ...
    rlt::free(device_gpu, gpu.parameters);
    rlt::free(device_gpu, gpu.states);
    rlt::free(device_gpu, gpu.next_states);
    rlt::free(device_gpu, gpu.reset_mask);
    rlt::free(device_gpu, gpu.actions);
    rlt::free(device_gpu, gpu.observations);
    rlt::free(device_gpu, gpu.observations_privileged);
    rlt::free(device_gpu, gpu.rewards);
    rlt::free(device_gpu, gpu.terminated_flags);
