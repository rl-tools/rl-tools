...
protected:
    ...
    void reset(){
        ...
        assign<DTYPE, LAYER_2_DIM, LAYER_1_DIM>(network.hidden_layer_0.weights     , hidden_layer_0_weights);
        memcpy(network.hidden_layer_0.biases, hidden_layer_0_biases.data(), sizeof(DTYPE) * LAYER_2_DIM);
...
#ifndef SKIP_TESTS
TEST_F(LAYER_IN_C_NN_BACKWARD_PASS, input_layer_weights) {
...
#ifndef SKIP_TESTS
TEST_F(LAYER_IN_C_NN_BACKWARD_PASS, input_layer_biases) {
    DTYPE out = abs_diff<
            DTYPE, LAYER_1_DIM
    >(
...
#ifndef SKIP_TESTS
TEST_F(LAYER_IN_C_NN_BACKWARD_PASS, hidden_layer_0_weights) {
    DTYPE out = abs_diff_matrix<
            DTYPE, LAYER_2_DIM, LAYER_1_DIM
    >(
            network.hidden_layer_0.d_weights,
...
#ifndef SKIP_TESTS
TEST_F(LAYER_IN_C_NN_BACKWARD_PASS, hidden_layer_0_biases) {
    DTYPE out = abs_diff<
            DTYPE, LAYER_2_DIM
    >(
            network.hidden_layer_0.d_biases,
