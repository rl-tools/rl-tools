...
void test_dynamic_full_conv2d_cuda(const char* label){
    DEVICE_CPU device_cpu;
    DEVICE_CUDA device_cuda;
    rlt::init(device_cuda);
    RNG_CPU rng_cpu;
    ...
    constexpr TI CHANNELS_OUT = CONV_CONFIG::OUTPUT_CHANNELS;
...
TEST(NN_LAYERS_DYNAMIC_CONV2D_CUDA, FULL_BASIC_3X3){
    ...
    test_dynamic_full_conv2d_cuda<CONFIG, 2, 8, 8, 8>("FULL_BASIC_3X3");
}
TEST(NN_LAYERS_DYNAMIC_CONV2D_CUDA, FULL_PADDED_3X3){
    ...
    test_dynamic_full_conv2d_cuda<CONFIG, 2, 8, 8, 8>("FULL_PADDED_3X3");
}
TEST(NN_LAYERS_DYNAMIC_CONV2D_CUDA, FULL_STRIDED_3X3){
    ...
    test_dynamic_full_conv2d_cuda<CONFIG, 2, 16, 16, 16>("FULL_STRIDED_3X3");
}
TEST(NN_LAYERS_DYNAMIC_CONV2D_CUDA, FULL_RELU_3X3){
    ...
    test_dynamic_full_conv2d_cuda<CONFIG, 2, 8, 8, 8>("FULL_RELU_3X3");
}
TEST(NN_LAYERS_DYNAMIC_CONV2D_CUDA, FULL_STRIDED_RELU){
    ...
    test_dynamic_full_conv2d_cuda<CONFIG, 2, 16, 16, 16>("FULL_STRIDED_RELU");
}
