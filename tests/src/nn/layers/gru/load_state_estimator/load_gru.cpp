...
using MODULE_CHAIN = rlt::nn_models::sequential::Module<GRU, rlt::nn_models::sequential::Module<DENSE>>;
...
TEST(RL_TOOLS_NN_LAYERS_GRU, LOAD_STATE_ESTIMATOR){
    ...
    auto file = rl_tools::persist::backends::hdf5::File(std::string(DATA_FILE_PATH), rl_tools::persist::backends::hdf5::Mode::READ);
