...
//    using CAPABILITY = rlt::nn::layer_capability::Forward;
    ...
    using GRU_SPEC_4X = rlt::nn::layers::gru::Specification<T, TI, SEQUENCE_LENGTH*4, INPUT_DIM, HIDDEN_DIM>;
    using GRU = rlt::nn::layers::gru::Layer<CAPABILITY, GRU_SPEC>;
    using GRU_4X = rlt::nn::layers::gru::Layer<CAPABILITY_BY_4 , GRU_SPEC_4X>;
