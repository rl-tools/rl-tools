...
using MODULE_CHAIN = rlt::nn_models::sequential::Module<INPUT_LAYER, rlt::nn_models::sequential::Module<GRU, rlt::nn_models::sequential::Module<DOWN_PROJECTION_LAYER_TEMPLATE, rlt::nn_models::sequential::Module<DENSE_LAYER_TEMPLATE>>>>;
