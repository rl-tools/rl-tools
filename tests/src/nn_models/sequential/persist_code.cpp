...
namespace MODEL_BENCHMARK{
    ...
    using MODEL = typename rlt::nn_models::sequential_v2::Build<rlt::nn::layer_capability::Gradient<rlt::nn::parameters::Adam, BATCH_SIZE>, MODULE_CHAIN, INPUT_SHAPE>;
}
...
namespace MODEL_2{
    ...
    template <typename T_CONTENT, typename T_NEXT_MODULE = rlt::nn_models::sequential_v2::OutputModule>
    using Module = typename rlt::nn_models::sequential_v2::Module<T_CONTENT, T_NEXT_MODULE>;
    using MODULE_CHAIN = Module<ACTOR_TYPE, Module<STANDARDIZATION_LAYER>>;
    using MODEL = typename rlt::nn_models::sequential_v2::Build<rlt::nn::layer_capability::Gradient<rlt::nn::parameters::Adam, BATCH_SIZE>, MODULE_CHAIN, INPUT_SHAPE>;
}
...
namespace MODEL_SAMPLE_AND_SQUASH{
    ...
    template <typename T_CONTENT, typename T_NEXT_MODULE = rlt::nn_models::sequential_v2::OutputModule>
    using Module = typename rlt::nn_models::sequential_v2::Module<T_CONTENT, T_NEXT_MODULE>;
    using MODULE_CHAIN = Module<SAMPLE_AND_SQUASH_LAYER, Module<ACTOR_TYPE>>;
    using CAPABILITY = rlt::nn::layer_capability::Gradient<rlt::nn::parameters::Adam, BATCH_SIZE>;
