...
namespace rl_tools{
    ...
    numeric_types::bfloat16 bfloat16_from_float(float f) {
        std::uint32_t bits;
        ...
        return numeric_types::bfloat16{top};
    }

    float bfloat16_to_float(numeric_types::bfloat16 b) {
        std::uint32_t bits = static_cast<std::uint32_t>(b.value) << 16;
        float f;
...
::rl_tools::numeric_types::bfloat16 operator+(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 a, RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 b) {
    return RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_from_float(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(a) + RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(b));
}
...
bool operator>(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 a, RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 b) { return RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(a) > RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(b); }
bool operator<(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 a, RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 b) { return RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(a) < RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(b); }
bool operator>=(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 a, RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 b) { return RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(a) >= RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(b); }
bool operator<=(RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 a, RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::numeric_types::bfloat16 b) { return RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(a) <= RL_TOOLS_NAMESPACE_WRAPPER ::rl_tools::bfloat16_to_float(b); }
