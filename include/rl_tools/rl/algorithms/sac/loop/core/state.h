...
namespace rl_tools{
    namespace rl::algorithms::sac::loop::core{
        ...
        struct State{
            ...
            Matrix<matrix::Specification<T, TI, CONFIG::CORE_PARAMETERS::SAC_PARAMETERS::SEQUENCE_LENGTH * CONFIG::CORE_PARAMETERS::SAC_PARAMETERS::CRITIC_BATCH_SIZE, CONFIG::ENVIRONMENT::ACTION_DIM>> action_noise_critic;
            typename CONFIG::NN::CRITIC_TYPE::template Buffer<> critic_buffers[2];
            ...
            Matrix<matrix::Specification<T, TI, CONFIG::CORE_PARAMETERS::SAC_PARAMETERS::SEQUENCE_LENGTH * CONFIG::CORE_PARAMETERS::SAC_PARAMETERS::CRITIC_BATCH_SIZE, CONFIG::ENVIRONMENT::ACTION_DIM>> action_noise_actor;
            typename CONFIG::NN::ACTOR_TYPE::template Buffer<> actor_buffers[2];
            typename CONFIG::NN::ACTOR_TYPE::template Buffer<> actor_buffers_eval;
            TI step;
