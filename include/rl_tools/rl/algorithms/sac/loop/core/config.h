...
//        using ALPHA_OPTIMIZER = nn::optimizers::Adam<typename NN::ALPHA_OPTIMIZER_SPEC>;
        ...
        static constexpr TI TARGET_SEQUENCE_LENGTH = CORE_PARAMETERS::SAC_PARAMETERS::SEQUENCE_LENGTH + (CORE_PARAMETERS::SAC_PARAMETERS::INCLUDE_FIRST_STEP_IN_TARGETS ? 1 : 0);

        using CRITIC_BATCH_SPEC = rl::components::off_policy_runner::SequentialBatchSpecification<OFF_POLICY_RUNNER_SPEC, ACTOR_CRITIC_TYPE::SPEC::PARAMETERS::SEQUENCE_LENGTH, ACTOR_CRITIC_TYPE::SPEC::PARAMETERS::CRITIC_BATCH_SIZE, CORE_PARAMETERS::ALWAYS_SAMPLE_FROM_INITIAL_STATE, CORE_PARAMETERS::SAC_PARAMETERS::INCLUDE_FIRST_STEP_IN_TARGETS, DYNAMIC_ALLOCATION>;
        using ACTOR_BATCH_SPEC = rl::components::off_policy_runner::SequentialBatchSpecification<OFF_POLICY_RUNNER_SPEC, ACTOR_CRITIC_TYPE::SPEC::PARAMETERS::SEQUENCE_LENGTH, ACTOR_CRITIC_TYPE::SPEC::PARAMETERS::ACTOR_BATCH_SIZE, CORE_PARAMETERS::SAC_PARAMETERS::INCLUDE_FIRST_STEP_IN_TARGETS, DYNAMIC_ALLOCATION>;
