...
namespace rl_tools::rl::loop::steps::evaluation{
    ...
    struct Config: T_NEXT {
        ...
        using RESULT_SPEC = rl::utils::evaluation::Specification<T, TI, typename NEXT::ENVIRONMENT_EVALUATION, EVALUATION_PARAMETERS::NUM_EVALUATION_EPISODES, EVALUATION_PARAMETERS::EPISODE_STEP_LIMIT>;
