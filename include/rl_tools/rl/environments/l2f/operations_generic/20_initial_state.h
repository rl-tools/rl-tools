...
namespace rl_tools{
    ...
    inline void initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, STATE& state);
    namespace rl::environments::l2f{
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateBase<STATE_SPEC>& state){
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateLastAction<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
        ...
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateLinearAcceleration<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateAngularVelocityDelay<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateLinearVelocityDelay<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StatePoseErrorIntegral<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
            initial_state(device, env, parameters, static_cast<typename STATE_SPEC::NEXT_COMPONENT&>(state));
            for (TI dim_i=0; dim_i<3; dim_i++){
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateRandomForce<STATE_SPEC>& state){
            initial_state(device, env, parameters, static_cast<typename STATE_SPEC::NEXT_COMPONENT&>(state));
            state.force[0] = 0;
            state.force[1] = 0;
            state.force[2] = 0;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateRandomOrientationOffset<STATE_SPEC>& state){
            initial_state(device, env, parameters, static_cast<typename STATE_SPEC::NEXT_COMPONENT&>(state));
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateRotors<STATE_SPEC>& state){
            initial_state(device, env, parameters, static_cast<typename STATE_SPEC::NEXT_COMPONENT&>(state));
    ...
    //            state.rpm[i] = (parameters.dynamics.action_limit.max - parameters.dynamics.action_limit.min) / 2 + parameters.dynamics.action_limit.min;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateRotorsHistory<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
        ...
        template<typename DEVICE, typename SPEC, typename PARAMETERS, typename STATE_SPEC>
        inline void _initial_state(DEVICE& device, rl::environments::Multirotor<SPEC>& env, PARAMETERS& parameters, rl::environments::l2f::StateTrajectory<STATE_SPEC>& state){
            using TI = typename DEVICE::index_t;
