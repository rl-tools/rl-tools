...
promoting a selected backend's output to the canonical `tests/data/rendering_raytracing_golden`
directory. Generator targets are excluded from the default build and are not registered with
CTest.
