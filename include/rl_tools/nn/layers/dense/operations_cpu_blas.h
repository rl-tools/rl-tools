...
namespace rl_tools{
    namespace nn::layers::dense{
        ...
        struct CHECK_FORMATS{
            ...
            static constexpr bool MIXED = utils::typing::is_same_v<PARAMETER_TYPE, __bf16> && utils::typing::is_same_v<INPUT_TYPE, __bf16> && utils::typing::is_same_v<OUTPUT_TYPE, float>;
