...
namespace rl_tools::nn::layers::standardize {
    ...
    struct LayerGradient: public LayerBackward<SPEC> {
        ...
        using OUTPUT_CONTAINER_SPEC = matrix::Specification<typename SPEC::TYPE_POLICY::template GET<numeric_types::categories::Activation>, typename SPEC::TI, SPEC::INTERNAL_BATCH_SIZE, SPEC::OUTPUT_DIM, SPEC::DYNAMIC_ALLOCATION, matrix::layouts::DEFAULT<typename SPEC::TI>, SPEC::CONST>;
