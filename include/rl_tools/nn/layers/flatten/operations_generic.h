...
namespace rl_tools{
    ...
    RL_TOOLS_FUNCTION_PLACEMENT void add_gradient(DEVICE& device, nn::layers::flatten::LayerGradient<SOURCE_SPEC>& source, nn::layers::flatten::LayerGradient<TARGET_SPEC>& target) {}
    template<typename SOURCE_DEVICE, typename TARGET_DEVICE, typename SOURCE_SPEC, typename TARGET_SPEC>
    RL_TOOLS_FUNCTION_PLACEMENT void copy_gradient(SOURCE_DEVICE& source_device, TARGET_DEVICE& target_device, const nn::layers::flatten::LayerGradient<SOURCE_SPEC>& source, nn::layers::flatten::LayerGradient<TARGET_SPEC>& target) {}
