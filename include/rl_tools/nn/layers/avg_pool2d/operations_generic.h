...
namespace rl_tools{
    ...
    RL_TOOLS_FUNCTION_PLACEMENT void copy(SD& sd, TD& td, const nn::layers::avg_pool2d::LayerForward<SS>& src, nn::layers::avg_pool2d::LayerForward<TS>& dst) {}
    template<typename SD, typename TD, typename SS, typename TS>
    RL_TOOLS_FUNCTION_PLACEMENT void copy(SD& sd, TD& td, const nn::layers::avg_pool2d::LayerBackward<SS>& src, nn::layers::avg_pool2d::LayerBackward<TS>& dst) {}
    template<typename SD, typename TD, typename SS, typename TS>
    RL_TOOLS_FUNCTION_PLACEMENT void copy(SD& sd, TD& td, const nn::layers::avg_pool2d::LayerGradient<SS>& src, nn::layers::avg_pool2d::LayerGradient<TS>& dst) {
