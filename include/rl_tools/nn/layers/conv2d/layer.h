    ...
    struct Specification: T_CAPABILITY, T_CONFIG{
        ...
        struct OUTPUT_SHAPE_FACTORY{
            ...
            static constexpr auto shape_unpack(tensor::shape_math::IndexSequence<Is...>){
                ...
                constexpr auto shape_array_channels = tensor::shape_math::compute_replace<TI, tensor::shape_math::rank<NEW_INPUT_SHAPE>()>(shape_array_width, CONFIG::OUTPUT_CHANNELS, static_cast<tensor::shape_math::SizeType>(length(NEW_INPUT_SHAPE{}) - 1));
