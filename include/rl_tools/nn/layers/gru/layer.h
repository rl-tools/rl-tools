...
namespace rl_tools::nn::layers::gru{
    template<typename T_T, typename T_TI, T_TI T_SEQUENCE_LENGTH, T_TI T_INPUT_DIM, T_TI T_HIDDEN_DIM, typename T_PARAMETER_GROUP=parameters::groups::Normal, typename T_CONTAINER_TYPE_TAG = TensorDynamicTag, bool T_FAST_TANH = false, bool T_STATIC = false, bool T_CONST = false>
...
//        static constexpr auto NUM_WEIGHTS = HIDDEN_DIM * INPUT_DIM + HIDDEN_DIM; // todo
    ...
    struct LayerForward{
        ...
        using WEIGHTS_INPUT_CONTAINER_SPEC = tensor::Specification<T, TI, WEIGHTS_INPUT_CONTAINER_SHAPE, tensor::RowMajorStride<WEIGHTS_INPUT_CONTAINER_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        ...
        using BIASES_INPUT_CONTAINER_SPEC = tensor::Specification<T, TI, BIASES_INPUT_CONTAINER_SHAPE, tensor::RowMajorStride<BIASES_INPUT_CONTAINER_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        ...
        using WEIGHTS_HIDDEN_CONTAINER_SPEC = tensor::Specification<T, TI, WEIGHTS_HIDDEN_CONTAINER_SHAPE, tensor::RowMajorStride<WEIGHTS_HIDDEN_CONTAINER_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        ...
        using BIASES_HIDDEN_CONTAINER_SPEC = tensor::Specification<T, TI, BIASES_HIDDEN_CONTAINER_SHAPE, tensor::RowMajorStride<BIASES_HIDDEN_CONTAINER_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        ...
        using INITIAL_HIDDEN_STATE_CONTAINER_SPEC = tensor::Specification<T, TI, INITIAL_HIDDEN_STATE_CONTAINER_SHAPE, tensor::RowMajorStride<INITIAL_HIDDEN_STATE_CONTAINER_SHAPE>, SPEC::STATIC, SPEC::CONST>;
    ...
    struct LayerBackward: LayerForward<T_SPEC>{
        ...
        using FULL_HIDDEN_SPEC = tensor::Specification<T, TI, FULL_HIDDEN_SHAPE, tensor::RowMajorStride<FULL_HIDDEN_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        ...
        using HIDDEN_SPEC = tensor::Specification<T, TI, SINGLE_HIDDEN_SHAPE , tensor::RowMajorStride<SINGLE_HIDDEN_SHAPE>, SPEC::STATIC, SPEC::CONST>;
        using HIDDEN_TYPE = typename SPEC::CONTAINER_TYPE_TAG::template type<HIDDEN_SPEC>;
        HIDDEN_TYPE n_pre_pre_activation;
        using OUTPUT_SPEC = tensor::Specification<T, TI, SINGLE_HIDDEN_SHAPE , tensor::RowMajorStride<SINGLE_HIDDEN_SHAPE>, SPEC::STATIC, SPEC::CONST>;
