...
namespace rl_tools::nn::loss_functions::mse {
    namespace internal::mse{
        ...
        void d_mse_d_x_kernel(devices::CUDA<DEV_SPEC> device, Matrix<SPEC_A> a, Matrix<SPEC_B> b, Matrix<SPEC_DA> d_a, Tensor<LOSS_WEIGHT_SPEC> loss_weight) {
            ...
            T loss_weight_value = get(device, loss_weight, 0);
...
//     template<typename DEV_SPEC, typename SPEC_A, typename SPEC_B, typename LOSS_WEIGHT_SPEC>
//     typename SPEC_A::T evaluate(devices::CUDA<DEV_SPEC> device, Matrix<SPEC_A> a, Matrix<SPEC_B> b, Tensor<LOSS_WEIGHT_SPEC> loss_weight) {
//         static_assert(containers::check_structure<SPEC_A, SPEC_B>);
//         using T = typename SPEC_A::T;
...
//             }
//         }
//         return acc * loss_weight_value / (SPEC_A::ROWS * SPEC_A::COLS);
//     }
