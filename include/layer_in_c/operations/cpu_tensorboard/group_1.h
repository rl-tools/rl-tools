#ifndef LAYER_IN_C_OPERATIONS_CPU_TENSORBOARD_GROUP_1
    #define LAYER_IN_C_OPERATIONS_CPU_TENSORBOARD_GROUP_1
    #include <layer_in_c/devices/cpu_tensorboard.h>
    #include <layer_in_c/utils/assert/declarations_cpu.h>
