...
//        group.createDataSet("d_biases_second_order_moment" , d_biases_second_order_moment);
        save(device, layer.d_weights_first_order_moment, group, "d_weights_first_order_moment");
        save(device, layer.d_weights_second_order_moment, group, "d_weights_second_order_moment");
        save(device, layer.d_biases_first_order_moment, group, "d_biases_first_order_moment");
        save(device, layer.d_biases_second_order_moment, group, "d_biases_second_order_moment");
    }
    template<typename DEVICE, typename SPEC>
...
//        weights_dataset.read(weights);
//        utils::persist::array_conversion::std_vector_to_matrix(device, layer.weights, weights);
...
//            d_weights_first_order_moment_dataset.read(layer.d_weights_first_order_moment.data);
            load(device, layer.d_weights_first_order_moment, group, "d_weights_first_order_moment");
...
//            d_weights_second_order_moment_dataset.read(layer.d_weights_second_order_moment.data);
            load(device, layer.d_weights_second_order_moment, group, "d_weights_second_order_moment");
...
//            d_biases_first_order_moment_dataset.read(layer.d_biases_first_order_moment.data);
            load(device, layer.d_biases_first_order_moment, group, "d_biases_first_order_moment");
...
//            d_biases_second_order_moment_dataset.read(layer.d_biases_second_order_moment.data);
            load(device, layer.d_biases_second_order_moment, group, "d_biases_second_order_moment");
        }
        else{
