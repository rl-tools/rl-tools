...
namespace layer_in_c::rl::components::on_policy_runner{
    ...
    void epilogue(devices::CPU_MKL<DEV_SPEC>& device, rl::components::on_policy_runner::Buffer<BUFFER_SPEC>& buffer, rl::components::OnPolicyRunner<typename BUFFER_SPEC::SPEC>& runner, Matrix<ACTIONS_SPEC>& actions, Matrix<ACTION_LOG_STD_SPEC>& action_log_std, RNG& rng, typename devices::CPU<DEV_SPEC> step_i){
