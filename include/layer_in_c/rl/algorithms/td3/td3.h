...
template <typename T, int T_LAYER_1_DIM, int T_LAYER_2_DIM, ActivationFunction FN>
struct ActorNetworkSpecification{
    ...
    static constexpr ActivationFunction LAYER_1_FN = FN;
    static constexpr ActivationFunction LAYER_2_FN = FN;
...
struct ActorCritic{
    typedef T_SPEC SPEC;
    typedef nn_models::three_layer_fc::AdamSpecification<typename SPEC::T, SPEC::ENVIRONMENT::OBSERVATION_DIM,
    SPEC::ACTOR_SPEC::LAYER_1_DIM, SPEC::ACTOR_SPEC::LAYER_1_FN,
    SPEC::ACTOR_SPEC::LAYER_2_DIM, SPEC::ACTOR_SPEC::LAYER_2_FN,
    SPEC::ENVIRONMENT::ACTION_DIM, layer_in_c::nn::activation_functions::TANH, typename SPEC::ACTOR_SPEC::ADAM_PARAMETERS> ACTOR_NETWORK_SPEC;

    typedef nn_models::three_layer_fc::InferenceSpecification<typename SPEC::T, SPEC::ENVIRONMENT::OBSERVATION_DIM,
    SPEC::ACTOR_SPEC::LAYER_1_DIM, SPEC::ACTOR_SPEC::LAYER_1_FN,
    SPEC::ACTOR_SPEC::LAYER_2_DIM, SPEC::ACTOR_SPEC::LAYER_2_FN,
    SPEC::ENVIRONMENT::ACTION_DIM, layer_in_c::nn::activation_functions::TANH> ACTOR_TARGET_NETWORK_SPEC;
    ...
    typedef layer_in_c::nn_models::three_layer_fc::AdamSpecification<typename SPEC::T, CRITIC_INPUT_DIM,
            SPEC::CRITIC_SPEC::LAYER_1_DIM, SPEC::CRITIC_SPEC::LAYER_1_FN,
            SPEC::CRITIC_SPEC::LAYER_2_DIM, SPEC::CRITIC_SPEC::LAYER_2_FN,
            1, layer_in_c::nn::activation_functions::LINEAR, typename SPEC::CRITIC_SPEC::ADAM_PARAMETERS> CRITIC_NETWORK_SPEC;
    typedef layer_in_c::nn_models::three_layer_fc::NeuralNetworkAdam<CRITIC_NETWORK_SPEC> CRITIC_NETWORK_TYPE;
    typedef layer_in_c::nn_models::three_layer_fc::InferenceBackwardSpecification<typename SPEC::T, CRITIC_INPUT_DIM,
            SPEC::CRITIC_SPEC::LAYER_1_DIM, SPEC::CRITIC_SPEC::LAYER_1_FN,
            SPEC::CRITIC_SPEC::LAYER_2_DIM, SPEC::CRITIC_SPEC::LAYER_2_FN,
    ...
    typedef layer_in_c::nn_models::three_layer_fc::InferenceSpecification<typename SPEC::T, CRITIC_INPUT_DIM,
            SPEC::CRITIC_SPEC::LAYER_1_DIM, SPEC::CRITIC_SPEC::LAYER_1_FN,
            SPEC::CRITIC_SPEC::LAYER_2_DIM, SPEC::CRITIC_SPEC::LAYER_2_FN,
...
void update_target_layer(Layer<SPEC>& target, const Layer<SPEC>& source, typename SPEC::T polyak) {
    utils::polyak::update_matrix<typename SPEC::T, SPEC::OUTPUT_DIM, SPEC::INPUT_DIM>(target.weights, source.weights, polyak);
    utils::polyak::update       <typename SPEC::T, SPEC::OUTPUT_DIM                 >(target.biases , source.biases , polyak);
}
...
template <typename SPEC>
void update_targets(ActorCritic<SPEC>& actor_critic) {
...
void init(ActorCritic<SPEC>& actor_critic, RNG& rng){
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>:: ACTOR_NETWORK_SPEC, RANDOM_UNIFORM, RNG>(actor_critic.actor, rng);
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>::CRITIC_NETWORK_SPEC, RANDOM_UNIFORM, RNG>(actor_critic.critic_1, rng);
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>::CRITIC_NETWORK_SPEC, RANDOM_UNIFORM, RNG>(actor_critic.critic_2, rng);
    ...
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>::ACTOR_TARGET_NETWORK_SPEC                    , RANDOM_UNIFORM, RNG>(actor_critic.actor_target, rng);
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>::CRITIC_TARGET_INFERENCE_BACKWARD_NETWORK_SPEC, RANDOM_UNIFORM, RNG>(actor_critic.critic_target_1, rng);
    layer_in_c::nn_models::init_weights<typename ActorCritic<SPEC>::CRITIC_TARGET_INFERENCE_NETWORK_SPEC                , RANDOM_UNIFORM, RNG>(actor_critic.critic_target_2, rng);
...
typename SPEC::T train_critic(ActorCritic<SPEC>& actor_critic, CRITIC_TYPE& critic, ReplayBuffer<typename SPEC::T, SPEC::ENVIRONMENT::OBSERVATION_DIM, SPEC::ENVIRONMENT::ACTION_DIM, CAPACITY>& replay_buffer, RNG& rng) {
...
template <typename SPEC, int CAPACITY, typename RNG>
typename SPEC::T train_actor(ActorCritic<SPEC>& actor_critic, ReplayBuffer<typename SPEC::T, SPEC::ENVIRONMENT::OBSERVATION_DIM, SPEC::ENVIRONMENT::ACTION_DIM, CAPACITY>& replay_buffer, RNG& rng) {
    typedef typename SPEC::T T;
