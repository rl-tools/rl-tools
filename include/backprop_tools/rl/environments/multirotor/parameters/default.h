...
namespace backprop_tools::rl::environments::multirotor::parameters {
    ...
    const rl::environments::multirotor::Parameters<T, TI, 4, default_internal::REWARD_FUNCTION<T>> default_parameters = {
            ...
            {0.02}, // integration dt
            {
                    ...
                    typename backprop_tools::rl::environments::multirotor::Parameters<T, TI, 4, default_internal::REWARD_FUNCTION<T>>::MDP::Termination({true, 2, 50/3.6, 5*2*backprop_tools::math::PI<T>}),
