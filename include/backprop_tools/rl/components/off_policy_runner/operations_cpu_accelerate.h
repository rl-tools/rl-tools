#include "../../../version.h"
#if (defined(BACKPROP_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(BACKPROP_TOOLS_RL_COMPONENTS_OFF_POLICY_RUNNER_OPERATIONS_CPU_ACCELERATE_H)) && (BACKPROP_TOOLS_USE_THIS_VERSION == 1)
#pragma once
