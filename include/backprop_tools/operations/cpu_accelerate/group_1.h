#include "../../version.h"
#if !defined(BACKPROP_TOOLS_OPERATIONS_CPU_ACCELERATE_GROUP_1_H) && (BACKPROP_TOOLS_USE_THIS_VERSION == 1)
#define BACKPROP_TOOLS_OPERATIONS_CPU_ACCELERATE_GROUP_1_H
#ifndef BACKPROP_TOOLS_OPERATIONS_CPU_ACCELERATE_GROUP_1
