...
namespace layer_in_c::nn_models {
    ...
    struct DefaultThreeLayerNeuralNetworkAdamSpecification{
        typedef T_T T;
    ...
    struct DefaultThreeLayerNeuralNetworkSGDSpecification{
        typedef T_T T;
        typedef layers::DefaultSGDParameters<T> SGD_PARAMETERS;
    ...
    struct ThreeLayerNeuralNetwork{
    ...
    template<typename NETWORK_SPEC>
    struct ThreeLayerNeuralNetworkAdam: public ThreeLayerNeuralNetwork<NETWORK_SPEC>{
        uint32_t age = 1;
    };

    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void forward(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, const typename NETWORK_SPEC::T input[NETWORK_SPEC::LAYER_1::INPUT_DIM]) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void evaluate(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, const typename NETWORK_SPEC::T input[NETWORK_SPEC::LAYER_1::INPUT_DIM], typename NETWORK_SPEC::T output[NETWORK_SPEC::OUTPUT_LAYER::OUTPUT_DIM]) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT typename NETWORK_SPEC::T evaluate(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, const typename NETWORK_SPEC::T input[NETWORK_SPEC::LAYER_1::INPUT_DIM]) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void zero_gradient(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network) {
        zero_gradient(network.layer_1);
        zero_gradient(network.layer_2);
        zero_gradient(network.output_layer);
    }
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void backward(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, const typename NETWORK_SPEC::T input[NETWORK_SPEC::LAYER_1::INPUT_DIM], const typename NETWORK_SPEC::T d_output[NETWORK_SPEC::OUTPUT_LAYER::OUTPUT_DIM], typename NETWORK_SPEC::T d_input[NETWORK_SPEC::LAYER_1::INPUT_DIM]) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void forward_backward_mse(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, const typename NETWORK_SPEC::T input[NETWORK_SPEC::LAYER_1::INPUT_DIM], typename NETWORK_SPEC::T target[NETWORK_SPEC::OUTPUT_LAYER::OUTPUT_DIM]) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void update(ThreeLayerNeuralNetworkAdam<NETWORK_SPEC>& network) {
    ...
    template<typename NETWORK_SPEC>
    FUNCTION_PLACEMENT void reset_optimizer_state(ThreeLayerNeuralNetworkAdam<NETWORK_SPEC>& network) {
    ...
    FUNCTION_PLACEMENT void init_weights(ThreeLayerNeuralNetwork<NETWORK_SPEC>& network, RNG& rng) {
