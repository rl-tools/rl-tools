...
//                        typename PARAMETERS_TYPE::Disturbances::UnivariateGaussian{0, 0} // random_force;
        ...
        static constexpr TI ACTION_HISTORY_LENGTH = 48;
#else
                static constexpr bpt::rl::environments::multirotor::StateType STATE_TYPE = ABLATION_SPEC::ROTOR_DELAY ? (
                    ABLATION_SPEC::ACTION_HISTORY ? bpt::rl::environments::multirotor::StateType::BaseRotorsHistory : bpt::rl::environments::multirotor::StateType::BaseRotors
                ) : bpt::rl::environments::multirotor::StateType::Base;
                ...
                static constexpr TI ENABLE_PRIVILEGED_OBSERVATION = ABLATION_SPEC::ASYMMETRIC_ACTOR_CRITIC;
            };
