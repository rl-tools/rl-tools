...
int main(int argc, char** argv){
    ...
    using ABLATION_SPEC_0 = AblationSpecTemplate< true,  true,  true,  true,  true,  true,  true, true>;
    using ABLATION_SPEC_1 = AblationSpecTemplate< true,  true,  true,  true,  true, false,  true, true>;
