...
struct CONFIG_FACTORY{
    ...
    struct ConfigApproximatorsVisual{
        ...
        struct Actor{
            ...
            using MODULE_CHAIN = rlt::nn_models::sequential::Module<CONV1, rlt::nn_models::sequential::Module<CONV2, rlt::nn_models::sequential::Module<AVG_POOL, rlt::nn_models::sequential::Module<MLP>>>>;
