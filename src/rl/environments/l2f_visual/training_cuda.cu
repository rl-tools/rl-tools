...
static constexpr T CAMERA_MOUNT_OFFSET_RANDOMIZATION_RANGE_X = static_cast<T>(0.0); // static_cast<T>(0.01);
static constexpr T CAMERA_MOUNT_OFFSET_RANDOMIZATION_RANGE_Y = static_cast<T>(0.0); // static_cast<T>(0.01);
static constexpr T CAMERA_MOUNT_OFFSET_RANDOMIZATION_RANGE_Z = static_cast<T>(0.0); // static_cast<T>(0.01);
static constexpr T CAMERA_MOUNT_ROTATION_RANDOMIZATION_RANGE_X = static_cast<T>(0.0); // static_cast<T>(5.0) / static_cast<T>(180) * rlt::math::PI<T>;
static constexpr T CAMERA_MOUNT_ROTATION_RANDOMIZATION_RANGE_Y = static_cast<T>(0.0); // static_cast<T>(5.0) / static_cast<T>(180) * rlt::math::PI<T>;
static constexpr T CAMERA_MOUNT_ROTATION_RANDOMIZATION_RANGE_Z = static_cast<T>(0.0); // static_cast<T>(5.0) / static_cast<T>(180) * rlt::math::PI<T>;
