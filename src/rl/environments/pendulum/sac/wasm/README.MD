...
```
```
docker run --rm -it -p 8000:8000 --mount type=bind,source=$(cd ../../../../../..; pwd),target=/rl_tools,readonly --mount type=bind,source=$(cd ../../../../../..; pwd)/static/rl.tools/build,target=/build --platform linux/amd64 --entrypoint /bin/bash  rltools/wasm_build
```
```
