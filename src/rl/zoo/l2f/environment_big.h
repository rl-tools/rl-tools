...
namespace rl_tools::rl::zoo::l2f{
    ...
    struct ENVIRONMENT_BIG_FACTORY{
        ...
        struct ENVIRONMENT_STATIC_PARAMETERS{
            ...
            using STATE_BASE = StateAngularVelocityDelay<StateAngularVelocityDelaySpecification<T, TI, ANGULAR_VELOCITY_HISTORY, StateLastAction<StateSpecification<T, TI, StateBase<StateSpecification<T, TI>>>>>>; // make sure to also change the observation to the delayed one
