...
namespace rl_tools::rl::zoo::l2f::sac_attitude_setpoint_ctbr{
    namespace rlt = rl_tools;
    template <typename DEVICE, typename TYPE_POLICY, typename TI, typename RNG, bool DYNAMIC_ALLOCATION=true>
    struct FACTORY{
        using ENVIRONMENT = typename ENVIRONMENT_ATTITUDE_SETPOINT_CTBR_FACTORY<DEVICE, TYPE_POLICY, TI>::ENVIRONMENT;
