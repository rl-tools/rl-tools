#include "environment_attitude_setpoint_minimal.h"
...
namespace rl_tools::rl::zoo::l2f::sac_attitude_setpoint_minimal{
    namespace rlt = rl_tools;
    template <typename DEVICE, typename TYPE_POLICY, typename TI, typename RNG, bool DYNAMIC_ALLOCATION=true>
    struct FACTORY{
        using ENVIRONMENT = typename ENVIRONMENT_ATTITUDE_SETPOINT_MINIMAL_FACTORY<DEVICE, TYPE_POLICY, TI>::ENVIRONMENT;
        struct LOOP_CORE_PARAMETERS: rlt::rl::algorithms::sac::loop::core::DefaultParameters<TYPE_POLICY, TI, ENVIRONMENT>{
            ...
            static constexpr TI N_WARMUP_STEPS_CRITIC = 20000;
