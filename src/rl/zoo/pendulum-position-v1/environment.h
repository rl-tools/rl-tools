...
#if (defined(RL_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(RL_TOOLS_RL_ZOO_PENDULUM_POSITION_V1_ENVIRONMENT_H)) && (RL_TOOLS_USE_THIS_VERSION == 1)
#pragma once
...
namespace rl_tools::rl::zoo::pendulum_position_v1{
    ...
    struct ENVIRONMENT_FACTORY{
        ...
        using ENVIRONMENT = environments::PendulumPosition<ENVIRONMENT_SPEC>;
