...
```
g++ -I include -I /usr/include/hdf5/serial/ -I .dependencies/build/stb-src/ src/nn_models/resnet/resnet_inference.cpp -std=c++17 -Ofast -DRL_TOOLS_BACKEND_ENABLE_OPENBLAS -DRL_TOOLS_ENABLE_HDF5=ON -lblas -L /usr/lib/x86_64-linux-gnu/hdf5/serial/ -lhdf5
```
```
...
Clang AST Dump
```
clang++ -I include -I /usr/include/hdf5/serial/ -I .dependencies/build/stb-src/ src/nn_models/resnet/resnet_inference.cpp -std=c++17 -DRL_TOOLS_BACKEND_ENABLE_OPENBLAS -DRL_TOOLS_ENABLE_HDF5=ON -Xclang -ast-dump -Xclang -ast-dump-filter=rl_tools -fsyntax-only > resnet_ast.txt
```
