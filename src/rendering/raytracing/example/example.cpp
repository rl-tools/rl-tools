...
int main(int argc, char** argv) {
    ...
    using SPEC = rlt::rl::environments::raytracing_example::Specification<T, TI, NUM_ENVS, 64, 64, 64, rlt::rendering::raytracing::BasicShading, false, 1, false, 1, OUTPUT_MODE>;
