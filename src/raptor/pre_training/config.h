...
namespace builder{
    ...
    struct FACTORY{
        using TYPE_POLICY = rl_tools::numeric_types::Policy<T>;
        ...
        //            static constexpr bool SHARED_BATCH = false;
            ...
            struct BATCH_SAMPLING_PARAMETERS: rl::components::off_policy_runner::SequentialBatchParameters<TYPE_POLICY, TI, SAC_PARAMETERS::SEQUENCE_LENGTH, rl::components::off_policy_runner::SequentialBatchParametersDefault>{
...
namespace builder{
    ...
    struct LOOP_ASSEMBLY{
        using TYPE_POLICY = typename T_CORE_CONFIG::TYPE_POLICY;
        ...
        struct LOOP_CHECKPOINT_PARAMETERS: rl::loop::steps::checkpoint::Parameters<TYPE_POLICY, TI>{
        ...
        using LOOP_EVALUATION_PARAMETERS = rl::loop::steps::evaluation::Parameters<TYPE_POLICY, TI, LOOP_CHECKPOINT_CONFIG, NUM_EVALUATION_EPISODES, EVALUATION_INTERVAL>;
        using LOOP_EVALUATION_CONFIG = rl::loop::steps::evaluation::Config<LOOP_CHECKPOINT_CONFIG, LOOP_EVALUATION_PARAMETERS>;
        struct LOOP_SAVE_TRAJECTORIES_PARAMETERS: rl::loop::steps::save_trajectories::Parameters<TYPE_POLICY, TI, LOOP_CHECKPOINT_CONFIG>{
        ...
        struct LOOP_NN_ANALYTICS_PARAMETERS: rl::loop::steps::nn_analytics::Parameters<TYPE_POLICY, TI, LOOP_CHECKPOINT_CONFIG>{
