...
```
Run it `./a.out 1337` (the number is the seed) then run `python3 -m http.server` to visualize the results. Open `http://localhost:8000` in your browser and navigate to the ExTrack UI to watch the quadrotor flying. 
