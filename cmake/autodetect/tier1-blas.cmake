if(NOT RL_TOOLS_BACKEND_DISABLE_BLAS)
    ...
    if(MKL_FOUND)
        ...
        set(RL_TOOLS_SUMMARY_BLAS_REASON "MKL ${MKL_VERSION}")
        ...
        if(BLAS_FOUND)
            ...
            message(STATUS "No BLAS library found, defaulting to naive backend. Performance will be suboptimal.")
            set(RL_TOOLS_SUMMARY_BLAS_REASON "no BLAS library found, naive backend")
        endif()
    endif()
endif()
