if(NOT RL_TOOLS_DISABLE_JSON)
    ...
    if(nlohmann_json_FOUND)
        ...
        set(RL_TOOLS_SUMMARY_JSON_REASON "system")
    elseif(GIT_FOUND)
        ...
        message(STATUS "nlohmann_json disabled (not found and no git)")
...
if(NOT RL_TOOLS_DISABLE_HDF5)
    ...
    if(HDF5_FOUND)
        ...
        message(STATUS "HDF5 not found, HDF5-dependent targets disabled")
        set(RL_TOOLS_SUMMARY_HDF5_REASON "not found")
    endif()
endif()
...
if(NOT RL_TOOLS_DISABLE_ZLIB)
    ...
    if(ZLIB_FOUND)
        ...
        set(RL_TOOLS_SUMMARY_ZLIB_REASON "system")
    elseif(GIT_FOUND)
        ...
        message(STATUS "ZLIB disabled (not found and no git)")
