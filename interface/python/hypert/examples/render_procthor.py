...
renderer = hypert.Renderer(width=320, height=240, num_cameras=len(YAWS_DEGREES), output="rgbd", shading="high")
renderer.init(scene)
...
for axis in axes.flat:
    axis.axis("off")
figure.suptitle(f"ProcTHOR-Train-1 — hypert ({renderer.backend} backend)")
figure.tight_layout()
plt.show()
